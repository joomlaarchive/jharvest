...
;(function($){
    "use strict";
    $.metadataRepeatable = function(container, options){
        this.$container = $(container);

        // check if alredy exist
        if(this.$container.data("metadataRepeatable")){
            return self;
        }

        // Add a reverse reference to the DOM object
        this.$container.data("metadataRepeatable", self);

        // merge options
        this.options = $.extend({}, $.metadataRepeatable.defaults, options);
  ...
  rowsContainer: null // container for rows, same as main container by default
    ...
    $.fn.metadataRepeatable = function(options){
        return this.each(function(){
            ...
            var inst = new $.metadataRepeatable(this, options);
            $(this).data('metadataRepeatable', inst);
        });
    };
